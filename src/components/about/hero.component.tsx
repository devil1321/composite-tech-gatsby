...
const Hero = () => {
  ...
  return (
    <div className='about-hero h-[100vh] bg-black text-white flex justify-center items-center'>
      <div className="about-hero-details w-1/2 p-5">
      ...
      {image && <GatsbyImage image={image.gatsbyImageData} alt="hero-image" />}
    </div>
  )
}
