...
const Main = () => {
  ...
  return (
    <div className='nav-main px-12 py-2 flex gap-5 md:gap-0 flex-wrap justify-between items-center'>
      ...
      <Link className="block w-[100%] md:w-fit font-bold px-4 py-2 rounded-full transition-all hover:text-white hover:bg-blue-400 border-[3px] border-blue-400 text-blue-400" to="/out-deals">Our Deals</Link>
    </div>
  )
}
