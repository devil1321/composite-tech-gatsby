...
const Form = () => {
  ...
  return (
    <div className='checkout-form w-2/3'>
      ...
      <div className="checkout-form">
        <form action="">
            <div className="checkout-form-field my-2">
                ...
                <input type="email" className='w-[60%] border-[1px] border-gray-300 px-2 py-1' />
            </div>
            ...
            <div className="checkout-form-field my-2">
                ...
                <input type="text" className='w-[60%] border-[1px] border-gray-300 px-2 py-1' />
            </div>
            <div className="checkout-form-field my-2">
            ...
            <div className="checkout-form-field my-2">
                ...
                <input type="text" className='my-1 w-[60%] border-[1px] border-gray-300 px-2 py-1' />
                <input type="text" className='my-1 w-[60%] border-[1px] border-gray-300 px-2 py-1' />
            </div>
            <div className="checkout-form-field my-2">
            ...
            <div className="checkout-country-menu-wrapper w-[60%]">
